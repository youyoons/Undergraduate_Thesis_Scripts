...
def process_study(scans,file_names,patient,exclusions,log_path,path_raw,path_proc):
    ...
    #print("Accession Number: ", accessnum)
    #Anonymize the accession number ********************************************
    #accessnum = anonymize_acnum(accessnum)
    ...
    for series in all_series:
        ...
        print("Series Description: ", all_series[series][0][2])
        #Create raw and processed series directories if they do not exist
        if (len(all_series[series])) > 1 and (all_series[series][0][2] in valid_series_desc):
            print("INSIDE")
          
            print("Accession Number: ", accessnum)
            #Anonymize the accession number ********************************************
            accessnum = anonymize_acnum(accessnum)
            print("Anonymized Accession Number: ", accessnum)
    ...
    directories = os.listdir(path_proc)
    for i in directories:
        if len(os.listdir(os.path.join(path_proc,i))) == 0:
            os.rmdir(os.path.join(path_proc, i))
...
if __name__=="__main__":
    ...
    if is_fracture:
        raw_data_dir = "/home/youy/Documents/ESC499/Copy_Scans/path_fractures.log"
        path_raw = "/home/youy/Documents/Spine/RawData_fractures"
        path_proc = "/home/youy/Documents/Spine/ProcessedData_fractures"
    else:
        raw_data_dir = "/home/youy/Documents/ESC499/Copy_Scans/path_no_fractures.log"
        path_raw = "/home/youy/Documents/Spine/RawData_no_fractures"
        path_proc = "/home/youy/Documents/Spine/ProcessedData_no_fractures"
