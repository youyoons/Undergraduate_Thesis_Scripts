...
#===================================================================================================
    ...
    for file_name in os.listdir("fractures_classification"):
...
#===================================================================================================    
    ...
    try:
        dicom_dwn4x_pp = cPickle.load(open("fractures_classification/dicom_3d_" + ac_num + "_dwn4x.pkl","rb"),encoding = 'latin1')
    except:
        dicom_dwn4x_pp = cPickle.load(open("fractures_classification/dicom_3d_" + ac_num + "_dwn4x.pkl","rb"))
...
#===================================================================================================
    ...
    for reference_ac in random_reference_acs:
        ...
        try:
            reference = cPickle.load(open("fractures_classification/" + reference_ac,"rb"),encoding = 'latin1')
        except:
            reference = cPickle.load(open("fractures_classification/" + reference_ac,"rb"))
...
#===================================================================================================
    ...
    for most_similar_reference_ac in top3_references:
        ...
        try:
            most_similar_reference = cPickle.load(open("fractures_classification/" + most_similar_reference_ac,"rb"),encoding = 'latin1')
        except:
            most_similar_reference = cPickle.load(open("fractures_classification/" + most_similar_reference_ac,"rb"))
...
#===================================================================================================
    ac_nums_pp = os.listdir("fractures_classification/")
    ac_nums = []
